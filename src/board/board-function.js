module.exports = {
    ...
    paint: function () {
        ...
        if (this.config.bgMaterial) {
            /** draw material background */
            const material = new Image();
            material.onload = () => {
                ctx.drawImage(material, dimension.baseStart, dimension.baseStart, dimension.baseWidth, dimension.baseHeight);
                nextStep.bind(this)();
            }
            material.src = this.config.bgMaterial;
        } else {
